...
H.register({
  ...
  -- { V.mainMod .. " + SHIFT + A", hl.dsp.exec_cmd(V.scriptToggle .. " " .. V.menu) },
  ...
  { V.mainMod .. " + SHIFT + V", hl.dsp.exec_cmd("pkill rofi || " .. V.scriptClipboard .. " c") },
  { V.mainMod .. " + SHIFT + CTRL + V", hl.dsp.exec_cmd("pkill rofi || " .. V.scriptClipboard .. " d") },
  { V.mainMod .. " + SHIFT + ALT + V", hl.dsp.exec_cmd("pkill rofi || " .. V.scriptClipboard .. " w") },
